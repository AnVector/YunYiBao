...
public class SeasonFragment extends ABaseFragment {
    ...
    private String[] array = new String[]{"1G", "2G", "3G", "5G","10G","30G","50G"};
    private String[] price = new String[]{"15元", "25元", "35元", "50元","88元","188元","288元"};
    private List<String> mData = Arrays.asList(array);
    private View mCurrent;

    @Override
    protected void initData() {
        tvPackageDesc.setText(mContext.getString(R.string.season_package_desc));
