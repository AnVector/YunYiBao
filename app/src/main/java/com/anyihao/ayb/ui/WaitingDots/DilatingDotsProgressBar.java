...
public class DilatingDotsProgressBar extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mDotScaleMultiplier = a.getFloat(R.styleable.DilatingDotsProgressBar_dd_scaleMultiplier,
                DEFAULT_GROWTH_MULTIPLIER);
        mAnimationDuration = a.getInt(R.styleable.DilatingDotsProgressBar_dd_animationDuration,
                300);
        mHorizontalSpacing = a.getDimension(R.styleable
                .DilatingDotsProgressBar_dd_horizontalSpacing, 12);
        a.recycle();
    ...
    private void initDots() {
        ...
        for (int i = 1; i <= mNumberDots; i++) {
            final DilatingDotDrawable dot = new DilatingDotDrawable(mDotColor, mDotRadius,
                    mDotMaxRadius);
            ...
            // Sizing
            ValueAnimator growAnimator = ObjectAnimator.ofFloat(dot, "radius", mDotRadius,
                    mDotMaxRadius, mDotRadius);
    ...
    /**
     * Set different start and end colors for dots. This will result in gradient behaviour. In
     * case you want set 1 solid
