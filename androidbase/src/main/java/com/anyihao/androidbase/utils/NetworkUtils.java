...
public class NetworkUtils {
    ...
    public static boolean setWifiEnabled(Context context, boolean enabled) {
        ...
        if (!enabled == isEnabled) {
            enabled = wifiManager.setWifiEnabled(enabled);
        }
        return enabled;
    }
    ...
    public static List<ScanResult> getWifiList(Context context){
        ...
        return sortWifiByLevel(mWifiManager.getScanResults());
    }

    private static List<ScanResult> sortWifiByLevel(List<ScanResult> list){
